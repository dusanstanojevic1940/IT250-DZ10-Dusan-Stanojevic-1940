...
import com.dusanstanojevic.MetHotels.dao.impl.GenericDAOimpl;
...
public class AppModule
{
	...
	//public static void configureRestResources(Configuration<Object> singletons, UserResource myDomainObjectResource)
	//{
        ...
        MappedConfiguration<String, Object> configuration)
    {
        ...
        configuration.add(SymbolConstants.HMAC_PASSPHRASE, "change this immediately- NO!");
    }
